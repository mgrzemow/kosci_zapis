...
- **Kolejka:** zakładka gracza, którego kolej, ma **zieloną ramkę** — zsynchronizowana między telefonami. Po wpisaniu wyniku (lub skreśleniu) kolejka **automatycznie** przechodzi na następnego gracza; **tap na zakładkę służy tylko do podglądu** karty danego gracza (nie zmienia kolejki). Próba wpisu poza swoją kolejką → komunikat błędu. Aplikacja wykrywa nierówną liczbę wpisów (różnica ≥ 2) i wyświetla ostrzeżenie. Przycisk „wstecz" w przeglądarce nie opuszcza gry bez potwierdzenia.
- **Poprawa wyniku:** przycisk „✏️ Poprawa wyniku" pozwala poprawić **jeden dowolny własny, już wpisany wynik** — nawet poza swoją kolejką. W trybie korekty pozostali gracze widzą baner „⚠️ UWAGA KOREKTA WYNIKÓW". Po wpisaniu poprawki aplikacja wraca do normalnego trybu, a **kolejka pozostaje bez zmian** (nie przechodzi na następnego gracza).
